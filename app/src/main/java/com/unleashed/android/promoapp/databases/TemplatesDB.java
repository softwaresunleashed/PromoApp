package com.unleashed.android.promoapp.databases;
...
public class TemplatesDB {
    ...
    private static final String databasename = "TemplatesDB";
    private static final String tablename = "TemplatesTable";    // TableName should NEVER be 'table' 'Table' 'TABLE'
    private static final int databaseversion = 1;

    // DB Table's Columns - Configure as per need.
    public static final String Col1 = "TemplateNickName";
    public static final String Col2 = "ProductTitle";
    public static final String Col3 = "ProductDescription";
    public static final String Col4 = "ProductLink";


    // Create Table SQL String
    private static final String create_table = "create table " + tablename + " (Id integer primary key AUTOINCREMENT, " + Col1 + " text not null, " + Col2 + " text not null" + Col3 + " text not null" + Col4 + " text not null" + ");";
    ...
    public TemplatesDB(Context context) {
        this.ct = context;
    ...
    public TemplatesDB connect() /* throws SQLException */  {
        try{
    ...
    public long insertRecord(String col1_value, String col2_value, String col3_value, String col4_value) {
    ...
    public boolean updateRecord(long id, String col1_value, String col2_value, String col3_value, String col4_value) throws SQLException {
        this.connect();
